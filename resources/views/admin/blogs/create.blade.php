...
@section('content')
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-slate-500 text-sm">Create a new blog post for your website.</p>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="glass-card p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" placeholder="Blog Title" value="{{ old('title') }}"
                    ...
                    <div class="glass-card p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="keyword" placeholder="e.g. banking, safety, technology" value="{{ old('keyword') }}"
                                class="w-full bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-violet-100">
                ...
                <div class="space-y-6">
                    ...
                    <div class="glass-card p-6 space-y-4">
                        ...
                        <div id="feature-image-preview-wrap" class="mb-4 hidden">
                            <img id="feature-image-preview" src="" alt="Preview" class="w-full h-40 object-cover rounded-xl shadow-inner bg-slate-100">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="image_alt" placeholder="Describe the image for accessibility & SEO" value="{{ old('image_alt') }}"
                                class="w-full bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-violet-100">
                        </div>
                    </div>
